...
const BUILTIN: &[(&str, &str)] = &[
    ...
    ("theme-arc", include_str!("../recipes/theme-arc.toml")),
    ("theme-greybird", include_str!("../recipes/theme-greybird.toml")),
    ("theme-materia", include_str!("../recipes/theme-materia.toml")),
    ("theme-orchis", include_str!("../recipes/theme-orchis.toml")),
    ("theme-dracula", include_str!("../recipes/theme-dracula.toml")),
    ("theme-nordic", include_str!("../recipes/theme-nordic.toml")),
    ("theme-catppuccin", include_str!("../recipes/theme-catppuccin.toml")),
